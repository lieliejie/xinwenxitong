<template>
  ...
  <div
    ...
    :class="{ show: store.showComments }"
    @click.self="store.showComments = false"
  >
    
    <div class="comment-sidebar" :class="{ show: store.showComments }">
      ...
      <div class="comment-header">
        ...
        <span class="comment-close" @click="store.showComments = false">✕</span>
      </div>
